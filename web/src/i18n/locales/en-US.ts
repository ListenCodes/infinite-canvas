export default {
    ...
    admin: {
        ratePerMinute: "Requests per minute", channelConcurrency: "Channel concurrency limit", channelRatePerMinute: "Channel requests per minute",
        title: "Platform administration", description: "Operate users, billing, providers, reconciliation, and audit history.", signInTitle: "Sign in as an administrator", forbiddenTitle: "Administrator access required", forbiddenDescription: "This page is limited to active platform administrators.", loadFailed: "Could not load administration data", actionFailed: "Administration action failed", invalidJson: "Enter valid JSON", evidenceRequired: "Evidence must include nonempty source and reference fields", users: "Users", channels: "Channels", jobs: "Tasks", audit: "Audit", user: "User", role: "Role", status: "Status", workspaces: "Workspaces", balance: "Available / reserved", lastLogin: "Last login", adjustWallet: "Adjust credits", features: "Cloud rollout", featureNames: { projects: "Projects", imageGeneration: "Images", videoGeneration: "Video", credits: "Credits" }, disable: "Disable", restore: "Restore", disableConfirm: "Disable this account and revoke access?", restoreConfirm: "Restore this account?", addChannel: "Add channel", channel: "Channel", capabilities: "Capabilities", credential: "Credential", rotateCredential: "Rotate credential", addModel: "Add model", reconciliation: "Reconciliation", providerTask: "Provider task", unknownSince: "Unknown since", nextReconcile: "Next check", deadline: "Release deadline", businessDeadline: "Execution deadline", reservation: "Reservation", ledger: "Ledger", outbox: "Outbox", resolve: "Resolve", time: "Time", action: "Action", actor: "Actor", target: "Target", reason: "Reason", workspace: "Workspace", amount: "Credit amount", confirmLargeDebit: "Confirm a large debit", channelName: "Channel name", secret: "New secret", model: "Model", price: "Credits per job", concurrency: "Concurrency limit", providerIdempotency: "Provider supports idempotency", limitsJson: "Limits JSON", resolution: "Resolution", evidenceJson: "Evidence JSON", modals: { wallet: "Adjust credits", features: "Cloud rollout", channel: "Provider channel", credential: "Rotate credential", model: "Create model version", resolve: "Resolve unknown outcome" },
    },
    modelAdapterErrors: {
    ...
    networkErrors: { imageGatewayInterrupted: "The network or gateway connection was interrupted. Retry manually later; the request may already have reached the provider." },
    prompts: {
        title: "Prompt Center",
    ...
    config: {
        ...
        channels: {
            description: "Choose a provider protocol, fetch models, then assign each model a capability and adapter. Auto detection is the default and can be overridden.",
            add: "Add provider",
        ...
        channelEditor: {
            ...
            modelDescription: "{{count}} selected; each model can detect or override its request adapter.",
            selectModels: "Select models",
            adapter: "Model adapter",
            adapters: {
                auto: "Auto detect",
                protocol: "Protocol default",
                "grok2api-image": "Grok2API image",
                "sub2api-image": "Sub2API image",
                "grok2api-video": "Grok2API video",
                "sub2api-video": "Sub2API video",
