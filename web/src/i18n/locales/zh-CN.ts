export default {
    ...
    theme: { toggle: "切换主题" },
    cloud: { signIn: "登录云端", signOut: "退出登录", email: "邮箱", password: "密码", signInFailed: "登录失败", projectConflict: "云端画布已在其他位置更新，请刷新后再试", syncRequired: "画布尚未同步到云端，请稍后重试", featureDisabled: "当前账号尚未启用此云端能力。", migrate: "迁移到云端", retryMigration: "重试迁移", migrationFailed: "云端迁移失败", downloadMigrationArchive: "下载迁移备份", activateMigration: "载入云端副本", activateMigrationConfirm: "用已导入的云端副本替换对应本地项目？已下载的迁移归档仍会保留。", activateMigrationChangedConfirm: "迁移归档创建后本地项目已有改动。载入云端副本会替换这些对应项目，是否继续？", migrationStatuses: { prepared: "已准备", uploaded: "已上传", validating: "校验中", importing: "导入中", published: "已发布", failed: "失败", deleted: "已删除" } },
    tasks: {
