export default {
    ...
    theme: { toggle: "切换主题" },
    cloud: { signIn: "登录云端", signOut: "退出登录", email: "邮箱", password: "密码", signInFailed: "登录失败", projectConflict: "云端画布已在其他位置更新，请刷新后再试", syncRequired: "画布尚未同步到云端，请稍后重试", featureDisabled: "当前账号尚未启用此云端能力。", migrate: "迁移到云端", retryMigration: "重试迁移", retryMigrationLoad: "重新读取迁移状态", migrationFailed: "云端迁移失败", downloadMigrationArchive: "下载迁移备份", activateMigration: "载入云端副本", activateMigrationConfirm: "用已导入的云端副本替换对应本地项目？已下载的迁移归档仍会保留。", activateMigrationChangedConfirm: "迁移归档创建后本地项目已有改动。载入云端副本会替换这些对应项目，是否继续？", migrationStatuses: { prepared: "已准备", uploaded: "已上传", validating: "校验中", importing: "导入中", published: "已发布", failed: "失败", deleted: "已删除" } },
    tasks: {
    ...
    admin: {
        ratePerMinute: "每分钟请求数", channelConcurrency: "渠道并发上限", channelRatePerMinute: "渠道每分钟请求数",
        title: "平台管理", description: "管理用户、积分、渠道、核对任务与审计记录。", signInTitle: "请以管理员身份登录", forbiddenTitle: "需要平台管理员权限", forbiddenDescription: "该页面仅对有效的平台管理员开放。", loadFailed: "加载管理数据失败", actionFailed: "管理操作失败", invalidJson: "请输入有效的 JSON", evidenceRequired: "证据必须包含非空的 source 和 reference 字段", users: "用户", channels: "渠道", jobs: "任务", audit: "审计", user: "用户", role: "角色", status: "状态", workspaces: "工作区", balance: "可用 / 冻结", lastLogin: "最后登录", adjustWallet: "调整积分", features: "云端灰度", featureNames: { projects: "项目同步", imageGeneration: "图片生成", videoGeneration: "视频生成", credits: "积分账本" }, disable: "禁用", restore: "恢复", disableConfirm: "禁用此账号并撤销访问？", restoreConfirm: "恢复此账号？", addChannel: "新增渠道", channel: "渠道", capabilities: "能力", credential: "凭据", rotateCredential: "轮换凭据", addModel: "新增模型", reconciliation: "核对依据", providerTask: "上游任务", unknownSince: "未知起点", nextReconcile: "下次核对", deadline: "释放截止", businessDeadline: "执行截止", reservation: "冻结", ledger: "流水", outbox: "发件箱", resolve: "核对", time: "时间", action: "动作", actor: "操作者", target: "目标", reason: "原因", workspace: "工作区", amount: "积分数量", confirmLargeDebit: "确认大额扣减", channelName: "渠道名称", secret: "新密钥", model: "模型", price: "单任务积分", concurrency: "并发上限", providerIdempotency: "上游支持幂等", limitsJson: "限制 JSON", resolution: "核对结论", evidenceJson: "证据 JSON", modals: { wallet: "调整积分", features: "云端灰度", channel: "渠道配置", credential: "轮换凭据", model: "创建模型版本", resolve: "核对未知结果" },
    },
    modelAdapterErrors: {
    ...
    networkErrors: { imageGatewayInterrupted: "网络或网关连接中断，请稍后手动重试；请求可能已到达上游，请勿连续重复提交" },
    prompts: {
        title: "提示词中心",
        library: "提示词库",
    ...
    config: {
        ...
        channels: {
            description: "每个渠道选择协议并拉取模型，再为每个模型指定能力和适配器；默认自动识别，也可手动覆盖。",
            add: "新增渠道",
            unnamed: "未命名渠道",
        ...
        channelEditor: {
            ...
            baseUrl: "接口地址",
            models: "渠道模型",
            modelDescription: "已选 {{count}} 个；每个模型可自动识别或手动选择适配器。",
            selectModels: "选择模型",
            adapter: "模型适配器",
            adapters: {
                auto: "自动识别",
                protocol: "协议默认",
                "grok2api-image": "Grok2API 图片",
                "sub2api-image": "Sub2API 图片",
                "grok2api-video": "Grok2API 视频",
                "sub2api-video": "Sub2API 视频",
                "custom-script": "自定义脚本",
            },
            scriptReady: "脚本已设",
            script: "调用脚本",
